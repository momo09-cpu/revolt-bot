...
┃ • NON
_- Gli account ufficiali di revolt-bot non sono responsabili dell'uso che fai della funzione "Sub Bot"._
...
_- Quando utilizzi determinati comandi che hanno l'obiettivo di causare disagio, inquietudine, fastidio o altri termini simili, verranno applicate le rispettive sanzioni o avvisi per preservare l'integrità degli utenti e il funzionamento di revolt-bot._

*QUESTO È IL REPOSITORIO UFFICIALE*
https://github.com/momo09-cpu/revolt-bot
...
*~ Grazie per aver dedicato del tempo a informarti su revolt-bot*
`.trim();
}
